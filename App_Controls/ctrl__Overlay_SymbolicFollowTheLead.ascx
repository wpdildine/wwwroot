<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctrl__Overlay_SymbolicFollowTheLead.ascx.cs" Inherits="App_Controls_ctrl__Overlay_SymbolicFollowTheLead" %>
...
<div class="e_overlay_content">
    ...
    <h1><span>Symbolic:</span> Follow the Lead</h1>
    ...
    <ol class="ol_gray" style="margin-bottom:30px;">
        ...
        <li><span class="num">4</span>Did the child consistently interact and communicate with the adult using gestures and/or words? 
            ...
            <div class="row">
                ...
                <label for="q4_c">50%
                    <em class="ans q4 correct">CORRECT!</em> </label> 
            </div>
            <div class="row">
