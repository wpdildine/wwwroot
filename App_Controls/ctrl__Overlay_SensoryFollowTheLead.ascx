<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctrl__Overlay_SensoryFollowTheLead.ascx.cs" Inherits="App_Controls_ctrl__Overlay_SensoryFollowTheLead" %>
...
<div class="e_overlay_content">
    ...
    <h1><span>Sensory:</span> Follow the Lead</h1>
    <h2>Interactive Evaluation</h2>
    <p class="intro">Please Note: There is some flexibility in the answers. For instance, where we say 0%, someone else may see one instance and say less than 50%. </p>
    <ol class="ol_gray" style="margin-bottom:30px;">
        <li><span class="num">1</span>Did the child initiate/pick the activity?  
            ...
            <div class="row">
                ...
                <label for="q1_e">0%
                    <em class="ans q1 correct">CORRECT!</em> </label> 
            </div>
        ...
        <li><span class="num">2</span>Is the child having fun/being playful? 
            ...
            <div class="row">
                ...
                <label for="q2_e">0%
                    <em class="ans q2 correct">CORRECT!</em> </label> 
            </div>
        ...
        <li><span class="num">3</span>Is the adult having fun/being playful?   
            ...
            <div class="row">
                ...
                <label for="q3_e">0%
                    <em class="ans q3 correct">CORRECT!</em> </label> 
            </div>
        ...
        <li><span class="num">4</span>Did the child consistently interact and communicate with the adult using gestures and/or words? 
            ...
            <div class="row">
                ...
                <label for="q4_d">Less than 50%
                    <em class="ans q4 correct">CORRECT! He pulled away and showed his frustration with Mom and Dad’s directions.</em> </label> 
            </div>
            <div class="row">
        ...
        <li><span class="num">5</span>Did the activity progress in new ways based on the child’s interests?  
            ...
            <div class="row">
                ...
                <label for="q5_e">0%
                    <em class="ans q5 correct">CORRECT!</em> </label> 
            </div>
        ...
        <li><span class="num">7</span>Which of these problems did you see in this sessions?<div class="note">Please note: The child may have a couple of these problems during the Floortime session as he or she shows different emotions. This one is most dominant. </div>
            ...
            <div class="row">
                ...
                <label for="q7_a"><abbr class="vocab"><abbr class="definitionbox"><abbr class="definition">When a child with autism feels overwhelmed, anxious, or uncomfortable, he or she is likely to avoid interaction by physically walking away or by withdrawing attention.</abbr></abbr><abbr class="term">Avoidance</abbr></abbr>/Distraction
                    <em class="ans q7 correct">CORRECT! </em> </label> 
            </div>
            <div class="row">
        ...
        <li><span class="num">8</span>Is the adult doing any of these things before or when it happened? <div class="note">Please Note: There are multiple answers for this question, select all that apply.</div>
            ...
            <div class="row">
                ...
                <label for="q8_a">Not following the Lead
                    <em class="ans q8 correct">CORRECT!</em> </label> 
            </div>
            <div class="row">
