...
//_56.innerHTML="<div style='background:blue;padding:20px'>TEST";
_56.innerHTML+=_55;
//_56.innerHTML+="</div>";
...
var _b6="";
//NALLEY PICKLES
_b6+="<table border=0 id='RadWindowWrapperElement"+id+"' class='RadWWrapperActive' style='display:none;margin-right: -6px; z-index:"+this.Zindex+";width:"+this.Width+";height:"+this.Height+";position:absolute;' cellspacing='0' cellpadding='0'>";  
    _b6+="<tbody style='"+(document.all?"":"height:100%")+"'>";
    _b6+="<tr class='RadWTitleRow' style='"+(this._visibleTitlebar?"":"display:none")+"'>";
        _b6+="<td valign='top' unselectable='on' grip='true' titleGrip='show' width='100%' style='height:3px;' class='RadWWrapperHeaderCenter' nowrap='true' >";
            _b6+="<div class='RadWHeaderTopResizer'>&nbsp;</div>";
            _b6+="<table border=0 cellspacing='0' cellpadding=0' width='100%' >";
                _b6+="<tr>";
                    _b6+="<td class='RadWWrapperHeaderCenter'>";
                        _b6+="<img ondblclick='"+_b3+".Close();return RadWindowNamespace.RadUtil_CancelEvent(event);' class='RadWIcon' src='"+this._iconUrl+"' align='absmiddle' border='0' />";
                    _b6+="</td>";
                    _b6+="<td id='RadWindowHeaderRow"+id+"' class='RadWWrapperHeaderCenter' nowrap width='100%'>\t";
                        _b6+="<span id='RadWindowTitle"+id+"' unselectable='on' onselectstart='return false;' class='RadWTitleText'>"+this._title+"</span>";
                    _b6+="</td>";
    ...
    _b6+="<tr height='100%' style='height:100%;'>";
        _b6+="<td align='left' id='RadWindowContentTD"+id+"' style='width:100%;height:100%;'>";
            _b6+="<table style='border:0px solid red;width:100%;height:100%;' cellspacing='0' cellpadding='0'>";
                _b6+="<tbody style='height:100%;'>";
                    _b6+="<tr height='100%' style='height:100%;'>";
                        _b6+="<td height='100%' style='height:100%;' width='100%' class='RadWWrapperBodyCenter' valign='bottom' align='left' onselectstart='return false;' >";
                            _b6+="<div style='position:relative;'>";
                                _b6+="<span class='TOPLEFT' style='position:absolute;top:0px;left:-3px;'></span>";
                                _b6+="<span class='TOPRIGHT' style='position:absolute; right:-3px; top:0px;'><a href='#' onclick='"+_b3+".Close();return RadWindowNamespace.RadUtil_CancelEvent(event);'>";
                                    _b6+="<img style='border:none;position: absolute; top: -12px; right: -10px;'  src='/App_Images/btn_close.png' alt='[x]' /></a>";
                                _b6+="</span>";
                            _b6+="</div>";
                            _b6+="<iframe class='RadWContentFrame' name='"+_b4+"' frameborder='0' style='border:0px solid green;width:100%;height:100%;' id='RadWindowContentFrame"+id+"' src='"+url+"' border='no'  ></iframe>";
                        _b6+="</td>";
                    _b6+="</tr>";    
                    _b6+="<tr style='height:1px;'>";
                        _b6+="<td class='RadWStatusRow'>";
                            _b6+="<div class='RadWStatus' style='"+(this._visibleStatusbar?"":"display:none")+"'> ";
                                _b6+="<span class='RadWLoadingWrapper' style='white-space:nowrap' id='RadWindowLoadingWrapper"+id+"'>";
                                    _b6+="<img align='absmiddle' src='"+this.private_GetImageUrl("loading.gif")+"' border='0'> "+this.GetLocalizedString("Loading")+"";
                                _b6+="</span>";
                                _b6+="<input style='font:icon;border:0px solid red;background-color:transparent;' unselectable='on' type='text' onselect='return false;' onbeforeactivate='return false;' onmousedown='return false;'  id='RadWStatus"+id+"'/>";
                            _b6+="</div>";
                        _b6+="</td>";
                    _b6+="</tr>";
                _b6+="</tbody>";
    ...
    _b6+="</tr>";
    _b6+="<tr>";
        _b6+="<td width='100%' height='1'>";
            _b6+="<table border='0' width='100%' height='1' cellspacing='0' cellpadding='0'>";
                _b6+="<tr>";
                    _b6+="<td width='100%' class='RadWWrapperFooterCenter' nowrap>&nbsp;</td>";
                _b6+="</tr>";
            _b6+="</table>";
        _b6+="</td>";
    _b6+="</tr>";
...
_26.Id=id;
_26.InitializePage(_3+"Img/transp-trans.png");
...
//_1.src=GetRadWindowManager()._schemeBasePath+"Img/transp-trans.png";
