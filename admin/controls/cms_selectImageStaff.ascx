<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cms_selectImageStaff.ascx.cs" Inherits="admin_controls_cms_selectImage" %>
...
function showAddDirectoryStaff() {
    ...
    function hideAddDirectoryStaff() {
...
<cc1:TabContainer ID="TabContainer1"   runat="server" ActiveTabIndex="0" OnClientActiveTabChanged="hideAddDirectoryStaff">
                ...
                <asp:updatepanel runat="server" id="UpdatePanel3Image" UpdateMode="Always" RenderMode="Inline">
                    <contenttemplate>
                        ...
                        <span style="padding-left:5px">
                            <a onclick="showAddDirectoryStaff();" style="cursor:pointer" id="CreateDirectory" runat="server" class="popup_btn popup_submit">Create Directory</a>
                        </span>
