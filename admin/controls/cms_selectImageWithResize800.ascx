<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cms_selectImageWithResize800.ascx.cs" Inherits="admin_controls_cms_selectImage" %>
...
<cc1:TabContainer ID="TabContainer1"   runat="server" ActiveTabIndex="0" OnClientActiveTabChanged="hideAddDirectory800">
                ...
                <asp:updatepanel runat="server" id="UpdatePanel3Image" UpdateMode="Always" RenderMode="Inline">
                    <contenttemplate>
                        ...
                        <span style="padding-left:5px">
                            <a onclick="showAddDirectory800();" style="cursor:pointer" id="CreateDirectory" runat="server" class="popup_btn popup_submit">Create Directory</a>
                        </span>
