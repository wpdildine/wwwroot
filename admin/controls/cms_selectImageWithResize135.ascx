<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cms_selectImageWithResize135.ascx.cs" Inherits="admin_controls_cms_selectImage" %>
...
<style type="text/css"><!--
    ...
    .dd_norm { background: #fff; color: #000; }
...
<cc1:TabContainer ID="TabContainer1"   runat="server" ActiveTabIndex="0" OnClientActiveTabChanged="hideAddDirectory135">
                ...
                <asp:updatepanel runat="server" id="UpdatePanel3Image" UpdateMode="Always" RenderMode="Inline">
                    <contenttemplate>
                        ...
                        <span style="padding-left:5px">
                            <a onclick="showAddDirectory135();" style="cursor:pointer" id="CreateDirectory" runat="server" class="popup_btn popup_submit">Create Directory</a>
                        </span>
